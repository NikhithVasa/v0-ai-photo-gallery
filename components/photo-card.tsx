...
export const PhotoCard = memo(function PhotoCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`pointer-events-none absolute inset-x-0 bottom-10 z-20 px-3 text-sm font-medium tracking-wide text-white transition-opacity duration-200 ${
          isDownloadHovering ? "opacity-100" : "opacity-0"
        }`}
      >
        Download Photo
      ...
      <div className="pointer-events-none absolute bottom-2 left-2 z-30 flex items-center gap-1 rounded-full bg-white/20 px-1.5 py-1 opacity-0 shadow-md backdrop-blur-md ring-1 ring-white/25 transition-opacity duration-200 group-hover:opacity-100 group-focus-within:opacity-100">
        <button
          type="button"
          className="pointer-events-auto flex h-7 w-7 cursor-pointer items-center justify-center rounded-full text-white transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/80"
        ...
        <button
          ...
          className="pointer-events-auto flex h-7 w-7 cursor-pointer items-center justify-center rounded-full text-white transition hover:bg-white/25 focus:outline-none focus:ring-2 focus:ring-white/80 disabled:cursor-not-allowed disabled:opacity-45"
...
export function PhotoLightbox({
  ...
  }, [isDownloadHovering, isPeopleOpen]);
  ...
  const overlayVisibilityClass =
    areControlsVisible || isPeopleOpen || isDownloadHovering
      ? "opacity-100"
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute right-3 top-3 z-30 flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-white drop-shadow transition-opacity duration-200 hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-white/70 sm:right-6 sm:top-5 ${overlayVisibilityClass}`}
      ...
      <button
        type="button"
        className={`absolute left-2 top-1/2 z-20 -translate-y-1/2 cursor-pointer rounded-full p-1 text-white drop-shadow transition-opacity duration-200 hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-white/70 sm:left-8 sm:p-2 ${overlayVisibilityClass}`}
        onClick={(event) => {
          event.stopPropagation();
          handlePrev();
        }}
      ...
      <button
        type="button"
        className={`absolute right-2 top-1/2 z-20 -translate-y-1/2 cursor-pointer rounded-full p-1 text-white drop-shadow transition-opacity duration-200 hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-white/70 sm:right-8 sm:p-2 ${overlayVisibilityClass}`}
        onClick={(event) => {
          event.stopPropagation();
          handleNext();
        }}
      ...
      >
        {imageUrl ? (
          ...
          >
            ...
            <div
              className={`pointer-events-none absolute bottom-12 left-3 z-20 text-sm font-medium tracking-wide text-white drop-shadow transition-opacity duration-200 sm:bottom-14 sm:left-4 ${
                isDownloadHovering ? "opacity-100" : "opacity-0"
              }`}
            >
              Download Photo
            ...
            <div
              className={`pointer-events-auto absolute bottom-3 left-3 z-30 flex items-center gap-1 rounded-full bg-white/20 px-1.5 py-1 text-white shadow-lg backdrop-blur-md ring-1 ring-white/25 transition-opacity duration-200 sm:bottom-4 sm:left-4 ${overlayVisibilityClass}`}
              onClick={(event) => event.stopPropagation()}
            >
              <button
                type="button"
                ...
                className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-full transition hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/70"
              ...
              <button
                ...
                disabled={isDownloading}
                className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-full transition hover:bg-white/25 focus:outline-none focus:ring-2 focus:ring-white/70 disabled:cursor-not-allowed disabled:opacity-45"
                aria-label="Download photo"
              >
                <Download className="h-4 w-4 stroke-1.5" />
              </button>
            ...
            <div
              className={`pointer-events-auto absolute bottom-3 right-3 z-30 transition-opacity duration-200 sm:bottom-4 sm:right-4 ${overlayVisibilityClass}`}
              onClick={(event) => event.stopPropagation()}
            >
              <button
                type="button"
                ...
                className="flex h-8 min-w-8 cursor-pointer items-center justify-center rounded-full bg-white/20 px-1 text-white shadow-lg backdrop-blur-md ring-1 ring-white/25 transition hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/70"
                ...
                {photoPeople.length ? (
                  <span className="flex -space-x-2">
                    {photoPeople.slice(0, 4).map((person) => (
                      <span
                        key={person.id}
                        className="relative h-6 w-6 overflow-hidden rounded-full bg-zinc-800 ring-1 ring-white/90"
                      >
                        {person.coverFaceUrl ? (
                          <img
